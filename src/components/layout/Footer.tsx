...
export default function Footer({ logoImage }: { logoImage?: string }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <Link href="/" className="text-3xl font-black tracking-tighter text-primary">
            {logoImage ? (
              <img src={logoImage} alt="Site Logo" className="h-10 md:h-12 w-auto object-contain brightness-0 invert" />
            ) : (
